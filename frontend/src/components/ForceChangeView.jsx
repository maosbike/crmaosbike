  ...
  return(
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"linear-gradient(135deg, #FFF7ED 0%, #FFFFFF 50%, var(--surface-sunken) 100%)",fontFamily:"'Inter',system-ui,sans-serif",padding:"24px"}}>
      <div style={{width:"100%",maxWidth:400}}>
        ...
        <form onSubmit={submit} style={{background:"#FFFFFF",border:"1px solid var(--surface-sunken)",borderRadius:16,padding:"36px 32px",boxShadow:"0 4px 24px rgba(0,0,0,0.10)"}}>
