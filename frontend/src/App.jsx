  ...
  return(
    <div style={{display:"flex",height:"100vh",background:"#F5F5F7",color:"#1a1a1a",fontFamily:"'Inter',system-ui,sans-serif",fontSize:14,overflow:"hidden"}}>
      ...
      <aside className="crm-sidebar" style={{width:210,background:"#FFFFFF",borderRight:"1px solid #E5E7EB",display:"flex",flexDirection:"column",flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center",gap:10,padding:"0 14px",height:52,borderBottom:"1px solid #E5E7EB"}}><div style={{width:30,height:30,borderRadius:8,background:"#F28100",display:"flex",alignItems:"center",justifyContent:"center"}}><Ic.bike size={17} color="white"/></div><span style={{fontSize:14,fontWeight:700,color:"#1a1a1a"}}>MaosBike <span style={{color:"#F28100"}}>CRM</span></span></div>
